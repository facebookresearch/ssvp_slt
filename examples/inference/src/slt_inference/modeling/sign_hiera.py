...
from .sign_hiera_utils import Reroll, Unroll, conv_nd, do_masked_conv, do_pool, pretrained_model


# From PyTorch internals
def _ntuple(n):
    """Credit: https://github.com/huggingface/pytorch-image-models/blob/main/timm/layers/helpers.py"""
...
class Mlp(nn.Module):
    """
    Credit: https://github.com/huggingface/pytorch-image-models/blob/main/timm/layers/mlp.py
...
def drop_path(x, drop_prob: float = 0.0, training: bool = False, scale_by_keep: bool = True):
    """
    Credit: https://github.com/huggingface/pytorch-image-models/blob/main/timm/layers/drop.py
    ...
    def extract_features(
        ...
        attn_mask = (
            ...
            if attention_mask is not None
                ...
                self.get_attention_mask(padding, device=x.device) if padding is not None else None
            )
        )
